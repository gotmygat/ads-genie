...
def pause_ad_group(
    ...
    *,
    ...
    """
    Pauses an ad group only when the account exists, autonomy policy is at least
    propose_and_wait, preview validation passes, and both intent/result are logged.
    """

    inputs = {"customer_id": customer_id, "ad_group_id": ad_group_id, "target_status": "PAUSED"}
    ...
    operation.update.status = enum_member(client, "AdGroupStatusEnum", "PAUSED")
